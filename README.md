...
- Supports Python 3.14 and FastAPI >= 0.135.3 (open an [issue](https://github.com/lschmelzeisen/fastapi-typed-client/issues) if you need support for older versions)
